...
- **Команды разработчика:**
  - Ты всегда находишься в текущей папке, тем необходимости выполнять `cd`.
  ...
  - Тестирование:
    ...
    - Тестирование N+1 запросов:
      ...
      - В `populate` блоке необходимо очищать кэш ActiveRecord и сбрасывать ассоциации между итерациями:
        ```ruby
        populate do |n|
