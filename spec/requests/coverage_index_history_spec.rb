...
RSpec.describe "CoverageIndexHistory", type: :request do
  ...
  describe "GET /coverage_index_history" do
    context "when authenticated as admin" do
      ...
      context "with valid team_ids" do
        ...
        it "returns 200 with history data" do
          ...
          expect(json["history"].first).to include("quarter_name" => quarter.full_name, "coverage_index" => a_kind_of(Integer))
        end
      end

      context "with empty team_ids" do
        it "returns 400" do
          get coverage_index_history_path, params: {team_ids: []}
      ...
      context "without team_ids param" do
        it "returns 400" do
          get coverage_index_history_path
