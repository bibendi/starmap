...
### 📋 Этап 3: Настройка аутентификации LDAP и ролевой модели
- [ ] Настроить Devise с LDAP
- [ ] Создать LDAP конфигурацию
- [ ] Создать Pundit policies для ролевой модели
- [ ] Настроить LDAP sync job
- [ ] Создать тестовых пользователей

### 📋 Этап 4: Создание основных моделей системы
- [ ] Создать модель User
- [ ] Создать модель Team
- [ ] Создать модель Technology
- [ ] Создать модель Quarter
- [ ] Создать модель SkillRating
- [ ] Создать модель ActionPlan
- [ ] Настроить ассоциации между моделями
- [ ] Добавить валидации
...
## Текущий статус: Этап 2 завершен, готов к Этапу 3 - Настройка аутентификации LDAP
