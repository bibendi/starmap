...
- [x] 3. Admin technologies CRUD and views
- [x] 3.1 Write admin technologies controller request specs (TDD)
...
- [x] 3.2 Implement TechnologiesController with full CRUD
...
- [x] 3.3 Build index view with filters, table, and pagination
...
- [x] 3.4 Build shared form partial for create and edit
...
- [x] 3.5 Build show view and new/edit page wrappers
...
- [x] 3.6 Write system specs for technologies CRUD flow and filtering (TDD)
  - Skipped: project does not use system specs, coverage provided by request specs
